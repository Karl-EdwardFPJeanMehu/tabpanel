				...
				if ( this.props.menu.length > 1 ){
					...
					return <div style={ _style.menuContainer }>
						{ this.props.menu.map((menu, index) => {
							...
							// set the bottom or top border
							// based on the value of the reverse prop
							let coloredBorder = this.props.reverse === true ? {borderTop: '2px'} : {borderBottom: '2px'}
